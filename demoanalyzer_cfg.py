...
# *** DoubleMu data sets, full ***
files2011data = []
datasets = FileUtils.os.walk(r"./datasets/Double")
for path, dir_list, file_list in datasets:
    for indexfile in file_list:
        files2011data.extend(FileUtils.loadListFromFile(FileUtils.os.path.join(path, indexfile)))

process.source = cms.Source("PoolSource", fileNames=cms.untracked.vstring(*files2011data))
...
process.TFileService = cms.Service(
    ...
    fileName=cms.string('DoubleMu2011.root'))
